...
emacs21 が modules.mk から消えたのは 2026-09-12 で、**この 2026-09-02 の複製には
まだ 15 個が名指しで残っていた。**trunk には 0 件である — 版を消すときに、それしか
受けない package (jde, leim21, bbdb2, nxml-mode) も一緒に消されている。

つまり「いま取り残しが在る」という話ではない。**版を引退させるたびに、package が
追いつくまでの窓が開く**という話で、この複製はたまたまその窓の中に在った。交わりを
取る理由はそれで足りる。
