...
configure found it and walk the returned list.  From Wolfgang S. Rupprecht;
the copyright notice he added is kept.  patch-ag and patch-bg are the config.in
and configure.in halves of the same change.
