...
named /usr/lib/crt0.o and then set CANNOT_DUMP, which makes a much slower
emacs that reloads all of lisp at every start.  Also stop overriding LINKER
on NetBSD, for the same reason as patch-ax.
