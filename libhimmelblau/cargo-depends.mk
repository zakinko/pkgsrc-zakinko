...
CARGO_CRATE_DEPENDS+=	assert_hex-0.4.1
...
CARGO_CRATE_DEPENDS+=	binary-stream-3.4.0
CARGO_CRATE_DEPENDS+=	bindgen-0.72.1
CARGO_CRATE_DEPENDS+=	binrw-0.15.1
CARGO_CRATE_DEPENDS+=	binrw_derive-0.15.1
...
CARGO_CRATE_DEPENDS+=	block-buffer-0.11.0
...
CARGO_CRATE_DEPENDS+=	c-types-6.0.0
CARGO_CRATE_DEPENDS+=	cbc-0.1.2
CARGO_CRATE_DEPENDS+=	cbindgen-0.29.4
...
CARGO_CRATE_DEPENDS+=	compact_jwt-0.5.6
...
CARGO_CRATE_DEPENDS+=	crypto-glue-0.1.18
...
CARGO_CRATE_DEPENDS+=	digest-0.11.0-rc.12
...
CARGO_CRATE_DEPENDS+=	hmac-0.13.0-rc.5
...
CARGO_CRATE_DEPENDS+=	kanidm-hsm-crypto-0.3.6
CARGO_CRATE_DEPENDS+=	kbkdf-0.1.0-rc.1
CARGO_CRATE_DEPENDS+=	keyutils-0.4.0
CARGO_CRATE_DEPENDS+=	keyutils-raw-0.4.0
CARGO_CRATE_DEPENDS+=	lazy_static-1.5.0
CARGO_CRATE_DEPENDS+=	lber-0.4.2
CARGO_CRATE_DEPENDS+=	ldap3_proto-0.6.2
CARGO_CRATE_DEPENDS+=	leb128fmt-0.1.0
CARGO_CRATE_DEPENDS+=	libc-0.2.186
CARGO_CRATE_DEPENDS+=	libkrimes-0.1.0
...
CARGO_CRATE_DEPENDS+=	malloced-1.3.1
...
CARGO_CRATE_DEPENDS+=	peg-0.8.6
CARGO_CRATE_DEPENDS+=	peg-macros-0.8.6
CARGO_CRATE_DEPENDS+=	peg-runtime-0.8.6
...
CARGO_CRATE_DEPENDS+=	serde-binary-0.5.0
...
CARGO_CRATE_DEPENDS+=	tss-esapi-8.0.0-alpha.2
CARGO_CRATE_DEPENDS+=	tss-esapi-sys-0.6.0
...
CARGO_CRATE_DEPENDS+=	uninit-0.3.0
