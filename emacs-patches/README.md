...
| cad/dinotrace-mode | accepted only emacs26 and emacs29; emacs26 is no longer in the tree and the "needs athena widgets" note dates from emacs28. 9.4f byte-compiles and (require 'dinotrace) loads on emacs30-nox11 and emacs31-nox11, so emacs29nox, emacs30, emacs30nox, emacs31 and emacs31nox are accepted too (the -nox11 flavours were built; the elisp does not touch X) | own | |
| chat/zenicb | accepted emacs31 only since 2026-09-08; builds and loads on emacs30-nox11 as well, so emacs30 and emacs30nox are accepted too | own | |
