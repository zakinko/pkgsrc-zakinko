...
# pkglint はこの file だけを見て x11 と xft2 と xface を「扱っているのに
...
# PLIST_VARS+= debug was here, but nothing ever set PLIST.debug and no
# PLIST line uses it, so it only produced two pkglint warnings.  The
# option itself still works: it just adds --debug to CONFIGURE_ARGS and
# does not change what is installed.
